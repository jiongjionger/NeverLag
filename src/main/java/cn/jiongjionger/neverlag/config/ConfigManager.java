...
public class ConfigManager extends AbstractConfig {
	...
	public boolean cleanItemEnabled;
	// 掉落物清理间隔
	@F("Cleaner.Item.Interval")
	public int cleanItemInterval;
	// 不清除物品的世界列表
	...
	public int cleanItemPlayerNearbyDistance;
	// 清理物品的时候是否公告
	@F("Cleaner.Item.Broadcast")
	public boolean cleanItemBroadcast;
	// 清理物品是否提前通知
	@F("Cleaner.Item.BroadcastForenotice")
	public boolean cleanItemForenotice;
	// 是否开启清理前60秒在物品上显示悬浮的倒计时
	@F("Cleaner.Item.HoloForenotice")
	public boolean cleanItemHoloForenotice = true;

	// 是否清理实体
	@F("Cleaner.Entity.Enabled")
	public boolean cleanEntity;
	// 实体清理周期
	@F("Cleaner.Entity.Interval")
	public int cleanEntityInterval;
	// 不清除实体的世界列表
	...
	public int cleanEntityPlayerNearbyDistance;
	// 实体清理阀值
	@F("Cleaner.Entity.CleanThreshold")
	public int cleanEntityThreshold;
	// 清理实体的时候是否公告
	@F("Cleaner.Entity.Broadcast")
	public boolean cleanEntityBroadcast;
	// 是否清除展示框
	@F("Cleaner.Entity.Type.ItemFrame")
	public boolean cleanEntityItemFrame;
	// 是否清除船
	@F("Cleaner.Entity.Type.Boat")
	public boolean cleanEntityBoat;
	// 是否清除经验球
	@F("Cleaner.Entity.Type.ExpBall")
	public boolean cleanEntityExpBall;
	// 是否清除正在掉落的物品
	@F("Cleaner.Entity.Type.FallingBlock")
	public boolean cleanEntityFallingBlock;
	// 是否清除画
	@F("Cleaner.Entity.Type.Painting")
	public boolean cleanEntityPainting;
	// 是否清理矿车
	@F("Cleaner.Entity.Type.Minecart")
	public boolean cleanEntityMinecart;
	// 是否清理地上的箭头
	@F("Cleaner.Entity.Type.Arrow")
	public boolean cleanEntityArrow;
	// 是否清理地上的雪球
	@F("Cleaner.Entity.Type.Snowball")
	public boolean cleanEntitySnowBall;
	// 是否清理动物
	@F("Cleaner.Entity.Type.Animal")
	public boolean cleanEntityAnimals;
	// 是否清理怪物
	@F("Cleaner.Entity.Type.Monster")
	public boolean cleanEntityMonster;
	// 是否清理乌贼
	@F("Cleaner.Entity.Type.Squid")
	public boolean cleanEntitySquid;
	// 是否清理村民
	@F("Cleaner.Entity.Type.Villager")
	public boolean cleanEntityVillager;
	// 清理实体的黑名单
	...
	// 是否检测超频红石
	@F("Redstone.Enabled")
	public boolean redstoneCheckEnabled;
	// 是否异步检测
	@F("Redstone.AsyncCheck")
	public boolean redstoneAsyncCheck;
	// 红石频率阀值
	@F("Redstone.Threshold")
	public int redstoneThreshold;
	// 红石中继器阀值
	@F("Redstone.DiodeThreshold")
	public int redstoneDiodeThreshold;
	// 红石检测周期
	@F("Redstone.CheckInterval")
	public int redstoneCheckInterval;
	// 红石清理列表
	@F("Redstone.RemoveTypeList")
	public Set<Integer> redstoneRemoveType = Collections.emptySet();
	// 直接清理还是自然掉落
	@F("Redstone.DropOnRemove")
	public boolean redstoneDropOnRemove;
	// 红石消息是否开启
	@F("Redstone.Broadcast")
	public boolean redstoneBroadcast;

	// 是否开启实体密集检测
	@F("MobCollision.Enabled")
	public boolean mobCollisionEnabled;
	// 实体密集检测大范围阀值
	@F("MobCollision.LargeLimit")
	public int mobCollisionLargeLimit;
	// 实体密集检测小范围阀值
	@F("MobCollision.SmallLimit")
	public int mobCollisionSmallLimit;
	// 实体密集检测周期
	@F("MobCollision.CheckInterval")
	public int mobCollisionCheckInterval;
	...
	public boolean isAntiChatCrash;
	...
	public boolean isAntiSignCrash;
	...
	public boolean isDisableChangeSpawnerType;
	...
	public int spawnLimitMonsterThreshold;
	@F("SpawnLimit.AnimalThreshold")
	public int spawnLimitAnimalThreshold;
	// 实体数量限制当TPS低于多少的时候才生效
	@F("SpawnLimit.TpsThreshold")
	public float spawnLimitTpsThreshold;
	// 区块实体数量大于多少的时候刷怪笼不再工作
	@F("SpawnLimit.MaxSpawnerEntityPerChunk")
	public int maxSpawnEntityPerChunk;

	// 是否开启农作物保护（防止玩家/怪物跳跃破坏农田）
	@F("Protect.Farm.Enabled")
	public boolean farmProtectEnabled;
	// 是否关闭爆炸破坏方块
	@F("Protect.Explode.Enabled")
	public boolean disableExplode;
	// 是否限制粘液块+粘液活塞的永动机
	@F("Tweaker.DisablePMM")
	public boolean disablePMM;

	// 是否限制Tiles数量
	@F("TileLimit.Enabled")
	public boolean tileLimitEnabled;
	// 投掷器默认限制阀值
	@F("TileLimit.DefaultLimits.Dropper")
	public int tileLimitDefaultDropper;
	// 漏斗默认限制阀值
	@F("TileLimit.DefaultLimits.Hopper")
	public int tileLimitDefaultHopper;
	// 发射器默认限制阀值
	@F("TileLimit.DefaultLimits.Dispenser")
	public int tileLimitDefaultDispenser;
	// 活塞默认限制阀值
	@F("TileLimit.DefaultLimits.Piston")
	public int tileLimitDefaultPiston;

	// 是否开启热区块常驻内存
	@F("HotChunkKeeper.Enable")
	public boolean hotChunkEnabled;
	/*
	...
	public boolean lowTPSActionEnabled;
	...
	public long lowTPSActionInterval;
